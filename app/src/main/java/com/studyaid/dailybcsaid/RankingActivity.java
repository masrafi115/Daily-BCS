...
public class RankingActivity extends  AppCompatActivity  { 
	...
	private DatabaseReference Ranking = _firebase.getReference("+data+");
	private ChildEventListener _Ranking_child_listener;
	@Override
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_Ranking_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				SketchwareUtil.sortListMap(list, "points", true, false);
		...
		Ranking.addChildEventListener(_Ranking_child_listener);
	}
	
	private void initializeLogic() {
		Ranking.removeEventListener(_Ranking_child_listener);
		ref = getIntent().getStringExtra("key");
		Ranking =
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.rank, null);
			}
			...
			_shapeRadius(linear6, "#2196F3", 90);
			textview8.setText(String.valueOf((long)(_position + 1)));
			textview5.setText(_data.get((int)_position).get("name").toString());
			textview4.setText(_data.get((int)_position).get("name").toString().substring((int)(0), (int)(1)));
			textview7.setText(_data.get((int)_position).get("points").toString());
