...
public class FeedbackActivity extends  AppCompatActivity  { 
	...
	private DatabaseReference feedbacks = _firebase.getReference("feedbacks");
	private ChildEventListener _feedbacks_child_listener;
	@Override
	...
	private void initialize(Bundle _savedInstanceState) {
			...
			public void onClick(View _view) {
				if (edittext1.getText().toString().equals("") && edittext1.getText().toString().equals("")) {
					...
					if (isConnected()) {
						...
						map.put("uid", "demo");
						feedbacks.push().updateChildren(map);
						SketchwareUtil.showMessage(getApplicationContext(), "Our Team will get back with you");
					}
					else {
		...
		_feedbacks_child_listener = new ChildEventListener() {
			@Override
		...
		feedbacks.addChildEventListener(_feedbacks_child_listener);
	}
	...
	private void initializeLogic() {
		...
		_shapeRadius(linear3, "#2196F3", 20);
	}
