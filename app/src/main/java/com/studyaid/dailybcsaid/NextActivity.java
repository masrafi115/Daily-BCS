...
public class NextActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_Subcategory_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				recyclerview1.setLayoutManager(new GridLayoutManager(NextActivity.this, 2));
	...
	public String _getMapToMapToString (final HashMap<String, Object> _map, final String _mapk1, final String _mapk2) {
		return new Gson().toJson((HashMap<String,Object>)_map.get(_mapk1));
	}
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			cardview1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					/*
if (_data.get((int)_position).get("type").toString().equals("contribute")) {
i.setClass(getApplicationContext(), WriteActivity.class);
startActivity(i);
}
else {
...
*/
					if (_data.get((int)_position).get("type").toString().equals("question")) {
						i.setClass(getApplicationContext(), PreparationActivity.class);
						i.putExtra("key", _data.get((int)_position).get("name").toString());
						startActivity(i);
					}
					else {
						i.setClass(getApplicationContext(), ArticleActivity.class);
						i.putExtra("category", _data.get((int)_position).get("name").toString());
						i.putExtra("data", _getMapToMapToString(_data.get((int)(_position)), "sub", "sub"));
