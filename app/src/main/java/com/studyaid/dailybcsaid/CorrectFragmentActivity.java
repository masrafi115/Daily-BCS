...
public class CorrectFragmentActivity extends  Fragment  { 
	...
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.correct_fragment, _container, false);
	...
	private void initializeLogic() {
		...
		list = (ArrayList<HashMap<String,Object>>)bundle.getSerializable("correct");
